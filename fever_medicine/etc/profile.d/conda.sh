export CONDA_EXE="$(cygpath 'C:/Users/Robin Aluma/Desktop/fever_medicines/fever_medicine\Scripts\conda.exe')"
export _CE_M=''
export _CE_CONDA=''
export CONDA_PYTHON_EXE="$(cygpath 'C:/Users/Robin Aluma/Desktop/fever_medicines/fever_medicine\python.exe')"
